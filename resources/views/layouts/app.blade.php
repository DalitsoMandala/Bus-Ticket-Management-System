...
<body>
    ...
    <div class="border-0 offcanvas offcanvas-end settings-panel d-none" id="settings-offcanvas"
        aria-labelledby="settings-offcanvas" tabindex="-1">
        <div class="offcanvas-header align-items-start border-bottom flex-column">
            <div class="pt-1 mb-6 w-100 d-flex justify-content-between align-items-start">
                <div>
                ...
                </div><button class="p-1 btn fw-bolder" data-bs-dismiss="offcanvas" type="button"
        ...
        <div class="offcanvas-body scrollbar px-card" id="themeController">
            <div class="mt-0 setting-panel-item">
                ...
                <div class="row gx-2">
                    <div class="col-6"><input class="btn-check" id="themeSwitcherLight" name="theme-color"
                            ...
                            class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherLight"> <span
                                class="mb-2 rounded d-block"><img class="mb-0 img-fluid img-prototype"
            ...
            <div class="p-4 bg-white border rounded-3 setting-panel-item">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="mb-1 setting-panel-item-title">RTL </h5>
                    <div class="mb-0 form-check form-switch"><input class="form-check-input ms-auto"
            ...
            <div class="p-4 bg-white border rounded-3 setting-panel-item">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="mb-1 setting-panel-item-title">Support Chat </h5>
                    <div class="mb-0 form-check form-switch"><input class="form-check-input ms-auto"
                ...
                <div class="row gx-2">
                    <div class="col-6"><input class="btn-check" id="navbarShapeDefault" name="navbar-shape"
                            ...
                            class="btn d-inline-block btn-navbar-style fs--1" for="navbarShapeDefault"> <span
                                class="mb-2 rounded d-block"><img class="mb-0 img-fluid img-prototype d-dark-none"
                                    src="../assets/img/generic/top-default.png" alt="" /><img
                                    class="mb-0 img-fluid img-prototype d-light-none"
                                    src="../assets/img/generic/top-default-dark.png" alt="" /></span><span
            ...
            </div><a class="mt-5 mb-3 text-white bun btn-primary d-grid dark__text-100 btn"
        ...
        <div class="px-2 py-1 card-body d-flex align-items-center">
            ...
            </div><small class="py-2 text-uppercase text-700 fw-bold pe-2 ps-1 rounded-end">customize</small>
        </div>
    </a>
