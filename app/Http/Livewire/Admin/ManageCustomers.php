...
public $showingModalManageCustomers;
...
# ---------------------------------------------------------------------------- #
    ...
    public function showModal()
    {
        ...
        $this->showingModalManageCustomers = true;
          if ($this->edit) {
            $this->button = 'UPDATE';
        } else {
            $this->button = 'SUBMIT';
    ...
    {
        $this->showingModalManageCustomers = false;
    }
...
# ---------------------------------------------------------------------------- #
    ...
    {
        return view('livewire.admin.manage-customers');
    }
}
