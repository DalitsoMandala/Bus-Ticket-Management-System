...
class DeleteSeats extends Component
{
...
public $showingModalDeleteSeats;
...
# ---------------------------------------------------------------------------- #
    ...
    public function showModal()
    {
        ...
        $this->showingModalDeleteSeats = true;
          if ($this->edit) {
            $this->button = 'UPDATE';
        } else {
            $this->button = 'SUBMIT';
    ...
    {
        $this->showingModalDeleteSeats = false;
    }
...
# ---------------------------------------------------------------------------- #
    ...
    {
        return view('livewire.admin.delete-seats');
    }
}
