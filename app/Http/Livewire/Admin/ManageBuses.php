...
class ManageBuses extends Component
{
...
public $showingModalManageBuses;
...
# ---------------------------------------------------------------------------- #
    ...
    public function showModal()
    {
        ...
        $this->showingModalManageBuses = true;
          if ($this->edit) {
            $this->button = 'UPDATE';
        } else {
            $this->button = 'SUBMIT';
    ...
    {
        $this->showingModalManageBuses = false;
    }
...
# ---------------------------------------------------------------------------- #
    ...
    {
        return view('livewire.admin.manage-buses');
    }
}
