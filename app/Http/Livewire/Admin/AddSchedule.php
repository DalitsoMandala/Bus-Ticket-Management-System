...
class AddSchedule extends Component
{
    ...
    public $showingModalAddSchedule;
    public $button = "SUBMIT";
    public $status, $depart_time, $check_in_time, $title;
    ...
    public function showModal()
    {
        ...
        $this->showingModalAddSchedule = true;
        if ($this->edit) {
            $this->button = 'UPDATE';
        } else {
            $this->button = 'SUBMIT';
    ...
    {
        $this->showingModalAddSchedule = false;
    }
    ...
    public function save()
    {
        ...
        if ($this->edit == '') {
            ...
            if ($validatedData) {
                ...
                Schedule::find($this->edit)->update([
                    'title' => $this->title,
                    'depart_time' => $this->depart_time,
                    'check_in_time' => $this->check_in_time
                ]);
    ...
    public function edit($data)
    {
        ...
        $data = Schedule::find($this->edit);



        $this->fill([
            'title' => $data->title,
            'depart_time' => Carbon::parse($data->depart_time)->format('H:i'),
            'check_in_time' => Carbon::parse($data->check_in_time)->format('H:i')
        ]);
