...
class BusChecker extends Component
{
    ...
    public function showModal()
    {
        ...
        $this->showingModalBusChecker = true;
        if ($this->edit) {
            $this->button = 'UPDATE';
        } else {
            $this->button = 'SUBMIT';
    ...
    {
        $this->showingModalBusChecker = false;
    }
...
*/
    ...
    {
        return view('livewire.bus-checker');
    }
}
