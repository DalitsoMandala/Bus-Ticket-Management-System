...
public $showingModalCheckLoginSession;
...
# ---------------------------------------------------------------------------- #
    ...
    public function showModal()
    {
        ...
        $this->showingModalCheckLoginSession = true;
          if ($this->edit) {
            $this->button = 'UPDATE';
        } else {
            $this->button = 'SUBMIT';
    ...
    {
        $this->showingModalCheckLoginSession = false;
    }
...
# ---------------------------------------------------------------------------- #
    ...
    {
        return view('livewire.check-login-session');
    }
}
